...
for protocol in 1.0; do
 for xml in ../../message_definitions/v$protocol/*.xml; do
     ...
     ./mavgen.py --lang=ROS --wire-protocol=$protocol --output=ROS/mavlink_v$protocol $xml || exit 1
     #mkdir -p python
...
cp -rf /home/slynen/Documents/projects/mavlink_ros/pymavlink/generator/ROS/mavlink_v1.0/include ./
